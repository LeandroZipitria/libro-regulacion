...
\addcontentsline{toc}{chapter}{\bibname}\bibliography{regulacion}
\usepackage{titling}
\pretitle{\begin{center} \begin{figure}[!h] \includegraphics[width=6.64in,height=9.36in]{imagenes/cover.jpg} \end{figure} \pagebreak}
